...
Resume point after **Sprint 60** (guild leaderboard). Total: **139 commits** on `master`, all pushed. Project chuẩn hoá **Node 24** (`.nvmrc`, engines >=24, Dockerfile node:24-alpine).
