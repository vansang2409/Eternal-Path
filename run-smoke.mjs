...
const FAST = [
  ...
  "smoke-mystery-test", "smoke-content2-test", "smoke-titles2-test", "smoke-guildbank-test", "smoke-disband-test", "smoke-inspect-test", "smoke-bagslot-test", "smoke-exchange-test", "smoke-goldboost-test", "smoke-friendnoti-test", "smoke-sellmat-test", "smoke-ecoachv-test", "smoke-pay-test", "smoke-who-test", "smoke-raidannounce-test", "smoke-motd-test", "smoke-guilddesc-test"
];
